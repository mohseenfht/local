...
function getMyCredit($id){
             ...
             $total = $DB->get_records_sql("select * from {user_credit} where user_id = ".$id);
             if(!empty($total) && count($total) != 0){
                    ...
                    if($id != 0){
                      ...
                      $insert_data->credit           =  $moodo->credit_default;
                      $res=$DB->insert_record('user_credit',$insert_data,true);
                      $t= $moodo->credit_default;
                    }
             }
