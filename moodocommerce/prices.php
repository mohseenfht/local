...
$output .= html_writer::start_tag('fieldset', array('class' => 'clearfix collapsible row'));
if(isset($msg)){
  $output .= '<div class="well">
        ...
        $output .= html_writer::link('payment.php', 'Order Summary', array('title' => 'View Orders' , 'class' => 'pull-right'));
...
$output .= html_writer::start_tag('fieldset' , array('class' => 'hidden row'));
        $output .= html_writer::start_tag('div' , array('class'=> 'fitem fitem_actionbuttons fitem_fgroup' , 'id' => 'fgroup_id_buttonar'));
           $output .= html_writer::start_tag('div' , array('class' => 'felement fgroup'));
               $output .= html_writer::start_tag('input' ,array('id'=> 'id_submitbutton' , 'name' => 'submitbutton' , 'value' => 'Set Price & seats' , 'type' => 'submit' ,'class' => 'btn btn-success' ));
               $output .= html_writer::start_tag('input' ,array('id'=> 'id_cancel' , 'name' => 'cancel' , 'value' => 'Cancel' , 'type' => 'reset' ,'class' => 'btn btn-danger'));
