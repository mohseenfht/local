...
if ($hassiteconfig) {
   ...
   // $page->add(new admin_setting_configtext('local_moodocommerce/credit_default',get_string('credit_default', 'local_moodocommerce'), get_string('credit_default', 'local_moodocommerce'),'20',PARAM_TEXT,40));
    ...
    $ccavenueStatus = array('1' => 'Enabled' , '0' => 'Disabled');
    $page->add(new admin_setting_heading('local_moodocommerce/moodocommerce_ccavenue', get_string('moodocommerce_ccavenue', 'local_moodocommerce'),''));
    $page->add(new admin_setting_configselect('local_moodocommerce/ccavenue_status', get_string('ccavenue_status', 'local_moodocommerce'),get_string('ccavenue_status', 'local_moodocommerce'), 'Disabled', $ccavenueStatus));
    $page->add(new admin_setting_configtext('local_moodocommerce/ccavenue_merchantid', get_string('ccavenue_merchantid', 'local_moodocommerce'),get_string('ccavenue_merchantid', 'local_moodocommerce'), '', PARAM_TEXT,40));
    $page->add(new admin_setting_configtext('local_moodocommerce/ccavenue_access',get_string('ccavenue_access', 'local_moodocommerce'), get_string('ccavenue_access', 'local_moodocommerce'),'',PARAM_TEXT,40));
    $page->add(new admin_setting_configtext('local_moodocommerce/ccavenue_workingkey',get_string('ccavenue_workingkey', 'local_moodocommerce'), get_string('ccavenue_workingkey', 'local_moodocommerce'),'',PARAM_TEXT,40));
