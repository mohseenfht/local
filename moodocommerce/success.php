...
//////////////////////////////////////// Enroll using CCAvenue Payment   /////////////////////////////
else if($type == 'ccavenue' && $USER->id == $userid) {

    include('payment/ccavenue/Crypto.php');
    $workingKey=$moodo->ccavenue_workingkey;   //Working Key should be provided here.
    ...
    if($order_status==="Success") {
                ...
                ///////////// Inserting Into Database  sending email start  ////////////////////////////////////////////////////////////////
                                ...
                                $insert_data->cardType        = 'Credit card (CCAvenue)';
                    ...
                    ///////////// Inserting Into Database  sending email start  ////////////////////////////////////////////////////////////////
                                    ...
                                    if($suess) {
                                         $successtxt = "Successfully enrolled to the course";
                                         echo '<div class="well">
            ...
            echo '<div class="well">
              <h5 style="color:red">Thank you for shopping with us.We will keep you posted regarding the status of your order through e-mail</h5>
              <a href="'.$CFG->wwwroot.'/local/moodocommerce/checkout.php">go to cart </a>
            </div>';
    }
    else if($order_status==="Failure")  {
            echo '<div class="well">
              <h5 style="color:red">Thank you for shopping with us.However,the transaction has been declined.</h5>
              <a href="'.$CFG->wwwroot.'/local/moodocommerce/checkout.php">go to cart </a>
            </div>';
    }
    else {
      echo '<div class="well">
              <h5 style="color:red">Security Error. Illegal access detected</h5>
              <a href="'.$CFG->wwwroot.'/local/moodocommerce/checkout.php">go to cart </a>
            </div>';
    }                              
}
